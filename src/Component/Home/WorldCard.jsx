       ...
       <div className={styles.main}>
           <div class={styles.innerbox}>
                ...
                <div className={styles.imgdiv}>
                    <img src = {data[34].img[0].img_url} style={{width:"100%",height:"355px"}}/>
                    <p style={{borderLeft:"2px solid red" ,margin:"-35px 10px",paddingLeft:"5px",fontSize:"small",fontWeight:"normal",color:"white"}}>{data[34].category}</p>
                    <p style={{margin:"-55px 10px",color:"white"}}>{data[17].headline}</p>
                </div>
           </div>
           <div class={styles.innerbox}>
                ...
                <div className={styles.imgdiv1}>
                    <img src = {data[19].img[0].img_url} style={{width:"100%",height:"355px"}}/>
