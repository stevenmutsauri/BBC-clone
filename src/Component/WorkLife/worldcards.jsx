                ...
                <div className={styles.main}>
                    ...
                    <div className={styles.inner}>
                        <div className={styles.uper}>
                            <img src = {data[0].img1} className={styles.img1}/>
                        ...
                        <div className={styles.bottom}>
                            <div className={styles.boxes}>
                                <img src={data[8].img1} className={styles.boximg}/>
                                <div>
                                    <p>{data[8].heading}</p>
                            ...
                            <div className={styles.boxes}>
                                <img src={data[7].img1} className={styles.boximg}/>
                                <div>
                                    <p>{data[7].heading}</p>
                                    <div style={{width:"70%",margin:"15px 0px 10px"}}>
                            ...
                            <div className={styles.boxes}>
                                <img src={data[2].img1} className={styles.boximg}/>
                                <div>
                                    <p>{data[2].heading}</p>
                                    <div style={{width:"70%",margin:"15px 0px 10px"}}>
