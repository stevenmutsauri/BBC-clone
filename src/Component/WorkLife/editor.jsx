                ...
                <div className={styles.main}>
                    ...
                    <div className={styles.inner}>
                        <div className={styles.uper}>
                            <img src = {data[3].img1} className={styles.img1}/>
                        ...
                        <div className={styles.bottom}>
                            <div className={styles.boxes}>
                                <img src={data[4].img1} className={styles.boximg}/>
                                <div>
                                    <p>{data[4].heading}</p>
                            ...
                            <div className={styles.boxes}>
                                <img src={data[5].img1} className={styles.boximg}/>
                                <div>
                                    <p>{data[5].heading}</p>
                                    <div style={{width:"70%",margin:"15px 0px 10px"}}>
                            ...
                            <div className={styles.boxes}>
                                <img src={data[6].img1} className={styles.boximg}/>
                                <div>
                                    <p>{data[6].heading}</p>
                                    <div style={{width:"70%",margin:"15px 0px 10px"}}>
